...
public class LockStockListener {
    ...
    @Subscribe
    public void doLockStock(LockStockEvent event){
        ...
        Response<Boolean> lockRlt = warehouseSkuWriteService.lockStock(warehouseShipmentList);
        if (!lockRlt.isSuccess()){
