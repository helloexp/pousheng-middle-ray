...
public class YyediSyncRefundService implements CompensateBizService {
    ...
    private void partRefundDoneProcess(Refund refund, Shipment shipment) {
        ...
        for (ShipmentItem shipmentItem : shipmentItems) {
            ...
            Integer confirmQuantity = refundConfirmQuantityMap.getOrDefault(shipmentComplexSkuCode, 0);
            Integer applyQuantity = refundApplyQuantityMap.getOrDefault(shipmentComplexSkuCode, 0);
