...
public class ShopOrderExtDao extends MyBatisDao<ShopOrderExt> {
    ...
    public ShopOrder findByOutIdAndOutFrom(String outId,String outFrom){
        return getSqlSession().selectOne(sqlId("findByOutIdAndOutFrom"), ImmutableMap.of("outId", outId, "outFrom", outFrom));
    }
