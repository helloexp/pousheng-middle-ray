...
public class RefundWriteLogic {
    ...
    @Autowired
    private RefundTemplatesWriteService refundTemplatesWriteService;
    @Autowired
...
//        ShopOrder shopOrder = orderReadLogic.findShopOrderById(submitRefundInfo.getOrderId());
     ...
     * @return
     */
    public boolean createsRefundTemplates(List<Refundtemplates> reftemplates){       
        Response<String> res = refundTemplatesWriteService.creates(reftemplates);
        if(res.isSuccess()){
            return true;
        }
        return false;
     ...
     * @param id
     */
    public void updateRefTemplatesStatus(Long id){
        refundTemplatesWriteService.updateApplyStatusByid(id);
    }
