...
public class SyncMposApi {
     ...
     * @return
     */
	public String syncMposShipmentInfo(Map<String, Object> param) {
		log.info("sync shipment from mpos, param:{}", param);
		String responseBody = paranaClient.systemPost("query.shipment.viampos.api", param);
		log.info("response:{}", responseBody);
		return responseBody;
	}
}
