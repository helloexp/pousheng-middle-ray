...
public class SupplyRuleExcelParser implements TaskBehaviour {
    ...
    public SupplyRuleExcelParser(Long taskId, String url, Boolean delta, AzureOSSBlobClient ossBlobClient, TaskWriteFacade taskWriteFacade) {
        this.taskId = taskId;
        this.url = url;
        this.delta = delta;
    ...
    public void preStart() {
        String filePath = ossBlobClient.downloadUrl(url);
