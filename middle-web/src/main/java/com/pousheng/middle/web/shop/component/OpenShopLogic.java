...
public class OpenShopLogic {
    ...
    public List<ShopChannelGroup> findShopChannelGroup(){
        ...
        if(!CollectionUtils.isEmpty(mposChannels)){
            ...
            Map<String, Long> zoneNameToZoneId = Maps.newHashMap();
            ...
            for (ShopChannel shopChannel : mposChannels){
                ...
                String zoneId = extra.get(ZONE_ID);
                if ((! "null".equals(zoneId)) && StringUtils.hasText(zoneId)) {
                    zoneNameToZoneId.put(zoneName, Long.valueOf(zoneId));
                }
            ...
            for (String zoneName : byZoneName.keySet()){
                ...
                zoneChannel.setZoneId(zoneNameToZoneId.get(zoneName));
