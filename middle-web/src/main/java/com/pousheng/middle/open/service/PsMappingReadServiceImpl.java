...
import io.terminus.open.client.common.mappings.service.OpenClientCategoryMappingService;
...
/**
 * 已迁移到open-client
 * @see io.terminus.open.client.mapping.impl.service.parana.ParanaItemMappingServiceImpl
...
public class PsMappingReadServiceImpl extends MappingReadServiceImpl implements MappingReadService{
    ...
    @Autowired
    public PsMappingReadServiceImpl(OpenClientBrandMappingService brandService,
                                    OpenClientItemMappingService itemService,
                                    OpenClientCategoryMappingService categoryService,
        ...
        super(brandService, itemService, categoryService);
