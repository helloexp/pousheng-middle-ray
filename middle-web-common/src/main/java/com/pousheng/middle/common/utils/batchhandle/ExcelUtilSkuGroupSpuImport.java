 ...
 */
public class ExcelUtilSkuGroupSpuImport {
     ...
     */
    public ExcelUtilSkuGroupSpuImport(OPCPackage pkg, PrintStream output,
                      int minColumns) {
    ...
    public static List<String[]> readerExcel(InputStream inputStream, int minColumns) throws OpenXML4JException, ParserConfigurationException, SAXException, IOException {
        ...
        ExcelUtilSkuGroupSpuImport xlsx2csv = new ExcelUtilSkuGroupSpuImport(p, System.out,
                 minColumns);
