...
//            //guofeng 同步oxo店发，发货信息到esp
//            OpenShop openShop = openShopCacher.findById(shipment.getShopId());
//            if (MiddleChannel.VIPOXO.getValue().equals(openShop.getChannel())) {
//                StoreShipmentShipedEvent event = new StoreShipmentShipedEvent();
//                event.setExpressbillno(shipmentExtra.getShipmentSerialNo());
//                event.setExpresscode(shipmentExtra.getShipmentCorpCode());
