...
@Slf4j
@Component
@Processor("parana_sku_orders")
public class SkuOrderProcessor implements IndexEventProcessor {
    private final IDEventProcessor idEventProcessor;

    public SkuOrderProcessor(OrderIndexManager orderIndexerManager, OrderSearchProperties orderSearchProperties) {
